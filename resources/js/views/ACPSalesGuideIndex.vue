<template>
  ...
  <div class="mx-auto max-w-6xl space-y-8">
    ...
    <!-- â”€â”€ Stage Mapping â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ -->
    <div>
      <ICardHeader>
        <div>
    ...
    <!-- â”€â”€ WhatsApp Templates â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ -->
    <div>
      <ICardHeader>
  ...
  <!-- â”€â”€ Edit Template Modal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ -->
  <IModal
  ...
  >
    <IFormGroup label="Template Content" label-for="tpl-content">
      <IFormTextarea
        ...
        rows="6"
        placeholder="Enter template messageâ€¦"
      />
...
// â”€â”€ Stage Mapping â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const pipelines           = ref([])
...
async function fetchMappings() {
  ...
  try {
    const { data } = await Innoclapps.request().get('/acp-sales-guide/stage-mappings')
...
async function saveMappings() {
  ...
  try {
    ...
    await Innoclapps.request().post('/acp-sales-guide/stage-mappings', { mappings })
...
async function fetchTemplates() {
  const { data } = await Innoclapps.request().get('/acp-sales-guide/templates')
...
async function updateTemplate() {
  await Innoclapps.request().put(
    `/acp-sales-guide/templates/${editingTemplate.value.id}`,
