<template>
  <Panel :panel="panel">
    ...
    <template v-else>
      ...
      <!-- â”€â”€ Stage Title â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ -->
      ...
      <!-- â”€â”€ Follow-up Stage Mode (Always active for Follow-up stages) â”€â”€ -->
      <template v-if="isFollowupStage">
        ...
        <!-- Has a pending follow-up â†’ show it as primary focus -->
        <div v-if="followupSummary.next" class="mb-6">
          <div class="rounded-xl border border-warning-200 bg-warning-50/40 p-4 dark:border-warning-500/20 dark:bg-warning-500/5 shadow-sm">
            ...
            <div class="flex gap-2">
              ...
              >
                <span class="mr-1">ðŸ“±</span> Send WhatsApp
              </IButton>
        ...
        <!-- No pending follow-up â†’ prompt to schedule the next one -->
      ...
      <!-- â”€â”€ Stage not mapped â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ -->
      <div
      ...
      >
        ...
        <ILink :to="{ name: 'acp-sales-guide' }" plain class="mt-1 block text-xs">
          Configure stage tools â†’
        </ILink>
      </div>

      <!-- â”€â”€ Visual Sequence Designer UI (For other stages) â”€â”€â”€â”€â”€â”€â”€â”€ -->
      <template v-else>
          <div v-if="nextPendingItem" class="rounded-xl border border-primary-100 bg-primary-50/30 p-4 dark:border-primary-500/20 dark:bg-primary-500/5 shadow-sm">
            ...
            <div v-if="nextPendingItem.is_template" class="space-y-3">
               ...
               <IButton
                ...
                >
                  <span class="mr-2">ðŸ“±</span> Send on WhatsApp
                </IButton>
            </div>
            ...
            <div v-if="showCompletedTasks" class="mt-2 space-y-2 opacity-60">
              ...
              >
                <div class="flex items-center gap-2">
                  <span class="text-success-500 text-xs">âœ“</span>
        ...
        <div class="mt-4 border-t border-neutral-100 pt-4 dark:border-neutral-800">
          ...
          <IFormTextarea
            ...
            rows="2"
            placeholder="Add context or outcome detailsâ€¦"
            class="mt-1"
          />
        </div>
    ...
    <!-- â”€â”€ Follow-ups â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ -->
    <div>
  ...
  <!-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
       ...
       IModal uses v-model:visible â€” NOT v-model.
       â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• -->
  <IModal
  ...
  >
    <div v-if="sc.script" class="space-y-4">
      ...
      <IFormGroup label="Note (Optional)" label-for="script-note">
        <IFormTextarea
          ...
          v-model="activityNote"
          rows="2"
          placeholder="Add outcome or contextâ€¦"
        />
      </IFormGroup>
    ...
    >
      ...
      <ILink :to="{ name: 'acp-sales-content' }" plain class="mt-1 block text-sm">
        Set it up in Sales Content Setup â†’
      </ILink>
    </div>
  </IModal>
    ...
    <div class="space-y-4">
      ...
      >
        ...
        <p class="mt-1 text-xs text-neutral-500 dark:text-neutral-400">
          Use the <strong>Documents</strong> tab on this deal page to create one â€”
      ...
      >
        <span>âš </span>
        <span>No phone number on contact â€” WhatsApp buttons are disabled.</span>
      </p>
    ...
    <div class="space-y-4">
      ...
      <IFormGroup label="Note (Optional)" label-for="fu-note">
        <IFormTextarea
          ...
          placeholder="What to discuss or sendâ€¦"
        />
      </IFormGroup>
    </div>
  </IModal>
...
// â”€â”€ Document status helpers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const DOC_STATUS = {
...
// â”€â”€ Guide state â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Follow-up Stage Mode â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Activity logging state â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const logging      = ref(false)
const activityNote = ref('')
const showNote     = ref(false)

// â”€â”€ Modal visibility â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Fetch guide from backend â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
async function fetchGuide() {
  fetchingGuide.value = true
  try {
    const { data } = await Innoclapps.request().get(
      `/acp-sales-guide/deals/${props.resourceId}/guide`
    )
    guide.value = data
  } catch (e) {
...
// â”€â”€ Toggle checklist item â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
async function toggleChecklistItem(itemKey) {
  try {
    const { data } = await Innoclapps.request().post(
      `/acp-sales-guide/deals/${props.resourceId}/guide/checklist-toggle`,
...
// â”€â”€ Log an activity â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// Sends ONLY action_type + optional note.
// Backend determines the current stage from the CRM â€” never from frontend.
...
// â”€â”€ Send WhatsApp using the step template â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Deal Documents (Estimate Shared step) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
async function fetchDealDocuments() {
  ...
  try {
    const { data } = await Innoclapps.request().get(
      `/acp-sales-guide/deals/${props.resourceId}/documents`
    )
...
// â”€â”€ Quick follow-up WhatsApp (always-visible section) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
async function sendFollowupWhatsApp(followup = null) {
  ...
  try {
    ...
    const { data } = await Innoclapps.request().get(
      `/acp-sales-guide/deals/${props.resourceId}/followup-whatsapp${templateParam}`
    )
    if (!data.has_phone) {
      Innoclapps.error('No phone number found. Add a phone number to the contact first.')
      return
...
async function fetchFollowups() {
  try {
    const { data } = await Innoclapps.request().get(
      `/acp-sales-guide/deals/${props.resourceId}/followups`
    )
...
async function markDone(followup) {
  try {
    await Innoclapps.request().put(
      `/acp-sales-guide/followups/${followup.id}/done`
    )
